...
setIsLoading(true)
let res = await axios.get("http://localhost:8080/api/v1/note/getAllNotes", {
  headers: {
 ...
 setIsLoading(false);
  ...
  const deleteNote = (index) => {
    ...
    var config = {
      ...
      url: "http://localhost:8080/api/v1/note/deleteNote",
      headers: {
  ...
  const updateNote=(id)=>{
    ...
    var config = {
      method: "put",
      maxBodyLength: Infinity,
      url: "http://localhost:8080/api/v1/note/updateNote",
      headers: {
